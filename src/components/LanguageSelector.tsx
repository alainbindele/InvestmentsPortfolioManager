...
export const LanguageSelector: React.FC<LanguageSelectorProps> = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="fixed top-full right-0 mt-2 w-40 sm:w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-[99999] animate-slide-up" style={{ zIndex: 99999 }}>
          <div className="py-2">
